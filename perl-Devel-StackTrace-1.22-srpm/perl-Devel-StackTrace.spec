...
%changelog
* Tue Oct 02 2012 Nico Kadel-Garcia <nico.kadel@tufts.edu>  1:1.22-0.4
- Publish out of date package number to provide RHEL 6 Server compatible
  version from RHEL 6 source.
